<?php /* Smarty version Smarty-3.1.19, created on 2018-02-02 17:11:12
         compiled from "module:ps_mainmenu/ps_mainmenu.tpl" */ ?>
<?php /*%%SmartyHeaderCode:4937184885a71d0c6895c72-07102753%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '4937184885a71d0c6895c72-07102753',
  'function' => 
  array (
    'menu' => 
    array (
  ...
  'unifunc' => 'content_5a71d0c691d340_24351148',
  'variables' => 
  array (
    'nodes' => 0,
    'depth' => 0,
...
<?php if ($_valid && !is_callable('content_5a71d0c691d340_24351148')) {function content_5a71d0c691d340_24351148($_smarty_tpl) {?><?php $_smarty_tpl->tpl_vars['_counter'] = new Smarty_variable(0, null, 0);?>
<?php if (!function_exists('smarty_template_function_menu')) {
    ...
    <?php if (count($_smarty_tpl->tpl_vars['nodes']->value)) {?>
        <ul class="top-menu position-static" <?php if ($_smarty_tpl->tpl_vars['depth']->value==0) {?>id="top-menu"<?php }?> data-depth="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['depth']->value, ENT_QUOTES, 'UTF-8');?>
">
...
">
                    ...
                    <a
                            ...
                            id="<?php if ($_smarty_tpl->tpl_vars['depth']->value===0) {?>dropdown-item<?php }?><?php if ($_smarty_tpl->tpl_vars['depth']->value===1) {?>dropdown-submenu<?php }?>"
...
" data-toggle="collapse"
                    ...
                    <?php if (count($_smarty_tpl->tpl_vars['node']->value['children'])) {?>
                        <div <?php if ($_smarty_tpl->tpl_vars['depth']->value===0) {?> class="popover sub-menu js-sub-menu collapse"<?php } else { ?> class="collapse"<?php }?>
